...
game directories.  The sys_* files pass this to host_init in QuakeHostParams->basedir.
...
void COM_LoadCacheFile (const char *path, cache_user_t *cu, unsigned int *path_id)
{
	loadcache = cu;
